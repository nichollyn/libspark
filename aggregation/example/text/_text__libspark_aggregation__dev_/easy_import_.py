...
class PackageInfo:
    ...
    package_identifiable_name = "aggregation.example.text"
    """
    ...
    dep_modules_map = {'aggregation': ["aggregation.aggregation"]}
    """
...
def pkg_init_intro():
    ...
    if not PackageInfo.dep_modules_map:
        deps_info = "\t     <None>"
