...
class PackageInfo:
    ...
    package_identifiable_name = "extension_system.test.manual.pluginview.plugins.plugin2"
    """
    ...
    dep_modules_map = {'extension_system': ["extension_system.iplugin"]}
    """
